...
def _system_prompt(faqs: list[dict]) -> str:
    ...
    return (
        ...
        "3. NO actúes como enciclopedia ni des explicaciones técnicas genéricas. Por "
        "ejemplo, si preguntan '¿qué es la RAM?' o piden specs de un producto puntual, "
        "responde que esos detalles están en la ficha del producto en la web y ofrece "
        "ayuda con lo que SÍ está cubierto (pago, envío, garantía, devoluciones, etc.).\n"
